...
namespace HelloWebApplication.HelloWebService {
    ...
    public interface HelloWebServiceSoap {
        ...
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/GetMessage", ReplyAction="*")]
        System.Threading.Tasks.Task<HelloWebApplication.HelloWebService.GetMessageResponse> GetMessageAsync(HelloWebApplication.HelloWebService.GetMessageRequest request);
    }
    ...
    public partial class HelloWebServiceSoapClient : System.ServiceModel.ClientBase<HelloWebApplication.HelloWebService.HelloWebServiceSoap>, HelloWebApplication.HelloWebService.HelloWebServiceSoap {
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        System.Threading.Tasks.Task<HelloWebApplication.HelloWebService.GetMessageResponse> HelloWebApplication.HelloWebService.HelloWebServiceSoap.GetMessageAsync(HelloWebApplication.HelloWebService.GetMessageRequest request) {
            return base.Channel.GetMessageAsync(request);
        }
        
        public System.Threading.Tasks.Task<HelloWebApplication.HelloWebService.GetMessageResponse> GetMessageAsync(string name) {
            HelloWebApplication.HelloWebService.GetMessageRequest inValue = new HelloWebApplication.HelloWebService.GetMessageRequest();
            inValue.Body = new HelloWebApplication.HelloWebService.GetMessageRequestBody();
            inValue.Body.name = name;
            return ((HelloWebApplication.HelloWebService.HelloWebServiceSoap)(this)).GetMessageAsync(inValue);
        }
    }
}
